...
int ONVIF_RECORDING_GetServiceCapabilities(char *username, char *password, char *recordingService)
{
    ...
    struct _trc__GetServiceCapabilities record_GetServiceCapabilities_req;
    struct _trc__GetServiceCapabilitiesResponse record_GetServiceCapabilities_resp;
    ...
    sprintf(soap_endpoint, "%s",recordingService);
    const char *soap_action = "http://www.onvif.org/ver10/recording/wsdl/GetServiceCapabilities";

    do
    {
        soap_call___trc__GetServiceCapabilities(soap, soap_endpoint, soap_action, &record_GetServiceCapabilities_req, &record_GetServiceCapabilities_resp);
        if (soap->error)
        {
...
int ONVIF_RECORDING_GetRecordings(char *username, char *password, char *recordingService)
{
    ...
    struct _trc__GetRecordings record_GetRecordings_req;
    struct _trc__GetRecordingsResponse record_GetRecordings_resp;
    ...
    sprintf(soap_endpoint, "%s",recordingService);
    const char *soap_action = "http://www.onvif.org/ver10/recording/wsdl/GetRecordings";

    do
    {
        soap_call___trc__GetRecordings(soap, soap_endpoint, soap_action, &record_GetRecordings_req, &record_GetRecordings_resp);
        if (soap->error)
        {
                printf("[%s][%d]--->>> soap error: %d, %s, %s\n", __func__, __LINE__, soap->error, *soap_faultcode(soap), *soap_faultstring(soap));
                retval = soap->error;
...
int ONVIF_RECORDING_GetRecordingConfiguration(char *username, char *password, char *recordingService, char* recordToken)
{
    ...
    struct _trc__GetRecordingConfiguration record_GetRecordingConfiguration_req;
    struct _trc__GetRecordingConfigurationResponse record_GetRecordingConfiguration_resp;
    ...
    sprintf(soap_endpoint, "%s",recordingService);
    const char *soap_action = "http://www.onvif.org/ver10/recording/wsdl/GetRecordingConfiguration";

    record_GetRecordingConfiguration_req.RecordingToken = recordToken;

    do
    {
        soap_call___trc__GetRecordingConfiguration(soap, soap_endpoint, soap_action, &record_GetRecordingConfiguration_req, &record_GetRecordingConfiguration_resp);
        if (soap->error)
        {
                printf("[%s][%d]--->>> soap error: %d, %s, %s\n", __func__, __LINE__, soap->error, *soap_faultcode(soap), *soap_faultstring(soap));
                retval = soap->error;
...
int ONVIF_RECORDING_GetTrackConfiguration(char *username, char *password, char *recordingService, char *recordToken, char *trackToken)
{
    ...
    struct _trc__GetTrackConfiguration record_GetTrackConfiguration_req;
    struct _trc__GetTrackConfigurationResponse record_GetTrackConfiguration_resp;
    ...
    sprintf(soap_endpoint, "%s",recordingService);
    const char *soap_action = "http://www.onvif.org/ver10/recording/wsdl/GetTrackConfiguration";

    record_GetTrackConfiguration_req.RecordingToken = recordToken;
    record_GetTrackConfiguration_req.TrackToken = trackToken;
    do
    {
        soap_call___trc__GetTrackConfiguration(soap, soap_endpoint, soap_action, &record_GetTrackConfiguration_req, &record_GetTrackConfiguration_resp);
        if (soap->error)
        {
                printf("[%s][%d]--->>> soap error: %d, %s, %s\n", __func__, __LINE__, soap->error, *soap_faultcode(soap), *soap_faultstring(soap));
                retval = soap->error;
